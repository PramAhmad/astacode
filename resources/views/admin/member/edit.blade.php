    ...
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" action="{{ route('member.update') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="exampleInputName1">Nama Member Team</label>
                <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="name" value="{{$member->name}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="exampleTextarea1" rows="4" name="about">{{$member->about}}</textarea>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail3">Nama Slug</label>
                <input type="text" class="form-control"  placeholder="Nama Slug" name="slug" value="{{$member->slug}}">
            </div>
            <div class="form-group">
            ...
            {{-- img preview --}}
            <div class="form-group">
                <img src="{{asset($member->photo)}}" alt="" width="100">
            </div>
            {{-- social media link --}}
            <div class="form-group">
                <label for="exampleInputName1">Facebook</label>
                <input type="text" class="form-control" id="exampleInputName1" placeholder="Facebook" name="facebook" value="{{$member->facebook}}">
            </div>
            <div class="form-group">
                <label for="exampleInputName1">Instagram</label>
                <input type="text" class="form-control" id="exampleInputName1" placeholder="Instagram" name="instagram" value="{{$member->instagram}}">
            </div>
            <div class="form-group">
                <label for="exampleInputName1">Linkedin</label>
                <input type="text" class="form-control" id="exampleInputName1" placeholder="Linkedin" name="linkedin" value="{{$member->linkedin}}">
            </div>
            <div class="form-group">
                <label for="exampleInputName1">Twitter</label>
                <input type="text" class="form-control" id="exampleInputName1" placeholder="Twitter" name="twitter" value="{{$member->twitter}}">
            </div>
