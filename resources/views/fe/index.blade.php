            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-8">
                    <div class="hero-content tw-max-w-[80%]">
                        ...
                        <h6 class="wow fadeInUp tw-text-3xl" data-wow-delay=".2s">Best it SOULTION Provider</h6>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="service-box-items style-2">
                        ...
                        <div class="content">
                            ...
                            <p>
                                We provide company profile websites, online shops, microsites, landing pages and others
                                according to the wishes and needs of clients with the best quality and affordable prices.
                            </p>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="service-box-items style-2 ">
                        ...
                        <div class="content">
                            ...
                            <p>
                                We provide Mobile application development services with an emphasis on custom application
                                development processes with an attractive UI and UX that supports the backend system
                                integration process.
                            </p>
                            <a href="service-details.html" class="theme-btn-2 mt-3">
                                read More
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                    <div class="service-box-items style-2">
                        ...
                        <div class="content">
                            ...
                            <p>
                                We provide creative visual content creation services in the form of graphic design,
                                animation, banners, logos, photography and videography and other content needs. and best
                                quality.
                            </p>
                            <a href="service-details.html" class="theme-btn-2 mt-3">
                                read More
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                    <div class="service-box-items style-2">
                        ...
                        <div class="content">
                            ...
                            <p>
                                We have good communication skills, from conducting research interviews with clients,
                                managing teams and stakeholders, writing business proposals, conducting presentations, to
                                writing reports.
                            </p>
                            <a href="service-details.html" class="theme-btn-2 mt-3">
                                read More
                        ...
                        <div class="about-image-items">
                            ...
                            <div class="about-img-1 tw-h-full  bg-cover wow fadeInLeft" data-wow-delay=".3s" style=" margin-bottom: 0%">
                                <img src="{{ asset('fe/assets/img/team/aboutteam3.png') }}" alt="about-img"
                                    style="background-position: center;width:400px;">
            ...
            <div class="row tw-mt-10">
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="md:tw-w-2/3 tw-w-full py-2 fadeInUp" data-wow-delay=".2s">
                        <div class="tw-relative tw-bg-white md:tw-my-10 tw-rounded-lg tw-shadow-lg tw-overflow-hidden">
                            <div class="tw-flex tw-items-center tw-justify-center tw-py-2 tw-pt-5">
                                <img src="{{asset('fe/assets/img/logo/node.png')}}"
                                    class="tw-w-20 tw-h-20" alt="">
                            </div>
                            <div class="tw-text-center tw-py-2">
                                <h5 class="tw-text-lg tw-font-medium">Node Js</h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="md:tw-w-2/3 tw-w-full py-2 fadeInUp" data-wow-delay=".2s">
                        <div class="tw-relative tw-bg-white md:tw-my-10 tw-rounded-lg tw-shadow-lg tw-overflow-hidden">
                            <div class="tw-flex tw-items-center tw-justify-center tw-py-2 tw-pt-5">
                                <img src="{{asset('fe/assets/img/logo/mysql.png')}}"
                                    class="tw-w-20 tw-h-20" alt="">
                            </div>
                            <div class="tw-text-center tw-py-2">
                                <h5 class="tw-text-lg tw-font-medium">Mysql</h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6  col-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="md:tw-w-2/3 tw-w-full py-2 fadeInUp" data-wow-delay=".2s">
                        <div class="tw-relative tw-bg-white md:tw-my-10 tw-rounded-lg tw-shadow-lg tw-overflow-hidden">
                            <div class="tw-flex tw-items-center tw-justify-center tw-py-2 tw-pt-5">
                                <img src="{{asset('fe/assets/img/logo/postgress.png')}}"
                                    class="tw-w-20 tw-h-20" alt="">
                            </div>
                            <div class="tw-text-center tw-py-2">
                                <h5 class="tw-text-lg tw-font-medium">Postgre</h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="md:tw-w-2/3 tw-w-full py-2 fadeInUp" data-wow-delay=".2s">
                        <div class="tw-relative tw-bg-white md:tw-my-10 tw-rounded-lg tw-shadow-lg tw-overflow-hidden">
                            <div class="tw-flex tw-items-center tw-justify-center tw-py-2 tw-pt-5">
                                <img src="{{asset('fe/assets/img/logo/mongo.png')}}"
                                    class="tw-w-20 tw-h-20" alt="">
                            </div>
                            <div class="tw-text-center tw-py-2">
                                <h5 class="tw-text-lg tw-font-medium">Mongo Db</h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="md:tw-w-2/3 tw-w-full py-2 fadeInUp" data-wow-delay=".2s">
                        <div class="tw-relative tw-bg-white md:tw-my-10 tw-rounded-lg tw-shadow-lg tw-overflow-hidden">
                            <div class="tw-flex tw-items-center tw-justify-center tw-py-2 tw-pt-5">
                                <img src="{{asset('fe/assets/img/logo/ionic.png')}}"
                                    class="tw-w-20 tw-h-20" alt="">
                            </div>
                            <div class="tw-text-center tw-py-2">
                                <h5 class="tw-text-lg tw-font-medium">Ionic</h5>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="md:tw-w-2/3 tw-w-full py-2 fadeInUp" data-wow-delay=".2s">
                        <div class="tw-relative tw-bg-white md:tw-my-10 tw-rounded-lg tw-shadow-lg tw-overflow-hidden">
                            <div class="tw-flex tw-items-center tw-justify-center tw-py-2 tw-pt-5">
                                <img src="{{asset('fe/assets/img/logo/tailwind.png')}}"
                                    class="tw-w-20 tw-h-20" alt="">
                            </div>
                            <div class="tw-text-center tw-py-2">
                                <h5 class="tw-text-lg tw-font-medium">Tailwind</h5>
                            </div>
                        </div>
                    </div>
